                ...
                var items = _context.Places
                    ...
                    .Where(b => !b.IsDeleted &&
                        (
                            ...
                            b.Link.Trim().ToLower().Contains(SearchByCityOrPlace.Trim().ToLower()) ||
                            b.Location.Trim().ToLower().Contains(SearchByCityOrPlace.Trim().ToLower()) ||
                            b.Description.Trim().ToLower().Contains(SearchByCityOrPlace.Trim().ToLower()) ||
                            ...
                            b.City.Description.Trim().ToLower().Contains(SearchByCityOrPlace.Trim().ToLower())
                        ));
